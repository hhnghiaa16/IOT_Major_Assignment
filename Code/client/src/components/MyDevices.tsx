/**
 * MyDevices Component (Dumb Component)
 * Pure UI component for device management
 */
...
const MyDevices: React.FC<MyDevicesProps> = ({ onClose }) => {
  ...
  const handleCopyToken = async (text: string) => {
    ...
    alert(success ? 'Đã copy token vào clipboard' : 'Không thể copy token');
  };
  ...
  return (
    <div className="my-devices-container">
          ...
          <form onSubmit={handleRegister} className="register-form">
            ...
            <div className="form-group">
              ...
              <p className="form-hint">
                MASTER: Thiết bị điều khiển chính | SLAVE: Thiết bị cảm biến/chấp hành
              </p>
            </div>
              ...
              {devices.map((device) => (
                <div key={device.id} className="device-card-new">
                  ...
                  <div className="device-actions">
                    {/* Show configure button for both Admin and Viewer */}
      ...
      {showInfoModal && (
        <div
          className="device-info-modal-overlay"
          onClick={() => {
            setShowInfoModal(false);
            setDeviceInfo(null);
          }}
              ...
              {infoLoading ? (
                ...
                <div className="device-info-list">
                  ...
                  <div className="device-info-item">
                    ...
                    <span
                      className={`device-badge ${
                        deviceInfo.connection_status === 'ONLINE'
                  ...
                  <div className="device-info-item">
                    ...
                    <div className="token-container">
                      ...
                      <button
                        ...
                        onClick={() => deviceInfo.token_verify && handleCopyToken(deviceInfo.token_verify)}
                        title="Copy token"
                      >
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="device-info-item">
                    ...
                    <span>
                      {deviceInfo.registered_at ? formatDateTime(deviceInfo.registered_at) : 'N/A'}
                    </span>
                  </div>
                </div>
              ) : (
